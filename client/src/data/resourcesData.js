...
export const RESOURCE_FORMATS = ['All Formats', 'PDF', 'FIG', 'ZIP', 'NOTION'];
...
export const RESOURCES_DATABASE = [
  ...
  },
  {
    ...
    tableOfContents: [
      ...
      'Section 2: VRAM Calculation Formula for Training & Inference (Weights + Gradients + Optimizer + KV Cache)',
    ...
    previewPages: [
      {
        ...
        content:
          'Every request is authenticated, authorized, and encrypted. Network perimeter defenses replaced by identity-centric access control policies.',
      },
    ],
  },
  {
    id: 'notion-engineering-career-os',
    title: 'Engineering Career OS: 90-Day Sprint & Goal Tracker',
    category: 'Resumes & Portfolios',
    format: 'NOTION',
    fileSize: '1.2 MB',
    pages: 'Full Notion Workspace',
    downloads: 8900,
    rating: 4.93,
    isFeatured: false,
    author: 'PathSeeker Senior Mentors',
    coverImage: 'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?auto=format&fit=crop&w=800&q=80',
    summary:
      'Complete Notion workspace with daily coding habit trackers, algorithmic problem log, system design case study databases, and job application pipeline CRM.',
    topics: ['Daily Habit Tracker', 'LeetCode Tracker CRM', 'Job Application Kanban', 'Design Case Studies'],
    tableOfContents: [
      'Dashboard: 90-Day Sprint Roadmap & Weekly Burn-down Chart',
      'Database 1: 150 Core Coding Problems with Spaced Repetition Tags',
      'Database 2: System Design Case Studies with Mermaid Architecture Embeds',
      'Database 3: Job Application Kanban Board (Applied -> Phone Screen -> Onsite -> Offer)',
    ],
    previewPages: [
      {
        pageNumber: 1,
        title: 'Spaced Repetition Problem Database',
        content:
          'Track problems by difficulty (Easy, Med, Hard), core pattern, confidence level (1-5), and automated review date triggers.',
      },
    ],
  },
];
