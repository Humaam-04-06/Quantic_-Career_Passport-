...
export const PENDING_MODERATION_STORIES = [
  {
    ...
    transition: 'Traditional Data Analyst ➔ Senior LLM Evaluation Engineer',
    company: 'Mistral AI',
    salaryJump: '$82k ➔ $175k (+113%)',
    hollandCode: 'IRC-91',
  ...
  },
  {
    ...
    transition: 'Physics Postdoc ➔ High-Frequency Algorithmic Quant',
    company: 'Jane Street Capital',
    salaryJump: '$65k ➔ $280k (+330%)',
    hollandCode: 'IRE-96',
  ...
  },
  {
    ...
    transition: 'Graphic Designer ➔ Lead AI Design Systems Architect',
    company: 'Figma',
    salaryJump: '$70k ➔ $160k (+128%)',
    hollandCode: 'AES-93',
